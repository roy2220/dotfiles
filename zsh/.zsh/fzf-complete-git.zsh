...
bindkey '\e_#KB#A-G\ab' _fzf-complete-git-branch
...
bindkey '^\e_#KB#A-G\at' _fzf-complete-git-tag
...
bindkey '\e_#KB#A-G\ac' _fzf-complete-git-commit
...
bindkey '\e_#KB#A-G\af' _fzf-complete-git-file
