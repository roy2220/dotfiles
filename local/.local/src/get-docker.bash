...
DOWNLOAD_URL=$(curl --silent --show-error --fail --request GET --location 'https://api.github.com/repos/docker/cli/tags' | python2 -c '
import json
import re
import sys
...
install -D "${TEMP_DIR}/docker/docker" docker
