...
DOWNLOAD_URL=$(curl --silent --show-error --fail --request GET --location https://api.github.com/repos/junegunn/fzf/releases/latest | python2 -c '
import json
import re
import sys
