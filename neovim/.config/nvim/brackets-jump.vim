...
function! s:init(language) abort
    ...
    execute 'xnoremap <buffer> <silent> [[ :<C-U>call <SID>ll_jump(v:false, v:true, '..string(a:language)..', v:count)<CR>'
    ...
    execute 'xnoremap <buffer> <silent> ]] :<C-U>call <SID>rr_jump(v:false, v:true, '..string(a:language)..', v:count)<CR>'
    ...
    execute 'xnoremap <buffer> <silent> [] :<C-U>call <SID>lr_jump(v:false, v:true, '..string(a:language)..', v:count)<CR>'
    ...
    execute 'xnoremap <buffer> <silent> ][ :<C-U>call <SID>rl_jump(v:false, v:true, '..string(a:language)..', v:count)<CR>'
    ...
    execute 'xnoremap <buffer> <silent> [{ :<C-U>call <SID>ll_jump(v:true, v:true, '..string(a:language)..', v:count)<CR>'
    ...
    execute 'xnoremap <buffer> <silent> ]} :<C-U>call <SID>rr_jump(v:true, v:true, '..string(a:language)..', v:count)<CR>'
    ...
    execute 'xnoremap <buffer> <silent> [} :<C-U>call <SID>lr_jump(v:true, v:true, '..string(a:language)..', v:count)<CR>'
    ...
    execute 'xnoremap <buffer> <silent> ]{ :<C-U>call <SID>rl_jump(v:true, v:true, '..string(a:language)..', v:count)<CR>'
endfunction
